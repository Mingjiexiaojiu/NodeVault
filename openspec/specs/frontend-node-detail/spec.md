...
### Requirement: User can view full node metadata（更新）
The system SHALL display a node detail page with all metadata fields from GET /api/v1/nodes/:id. 部门信息 SHALL 展示为"组织名称 / 团队名称"格式，替代原 namespace_id/department_slug。
